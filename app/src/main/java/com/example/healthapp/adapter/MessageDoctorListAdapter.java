...
public class MessageDoctorListAdapter extends RecyclerView.Adapter<MessageDoctorListAdapter.MyViewHolder> {
    Context context;
    List<Doctor> models;
    private OnItemClickListener mListener;

    public MessageDoctorListAdapter(Context context, List<Doctor> models) {
    ...
    public void setSingleData(Doctor models) {
        this.models.add(models);
        notifyDataSetChanged();
    }
    public void remvoeAllData() {
        this.models.clear();
        notifyDataSetChanged();
    }
