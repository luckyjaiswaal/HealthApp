...
public class AppointmentListAdapter extends RecyclerView.Adapter<AppointmentListAdapter.MyViewHolder> {
    ...
    public AppointmentListAdapter(Context context, List<Booking> models) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.detail.setText("Patient: " + model.getPatient().getFirstName() + " " +
                model.getPatient().getLastName() + "\nEmail: " + model.getPatient().getEmail() + "\nNotes: " + model.getNote());
    }
